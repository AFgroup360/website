...
def header():
  ...
  <div class="container site-header__inner">
    <a class="brand" href="/">Ameri<em>Financial</em></a>
    <nav class="nav" id="primary-nav" aria-label="Primary">
{links}
        <a class="nav__link nav__link--portal" href="/portal">Client Portal</a>
    </nav>
    <div class="header__actions">
      <a class="btn btn--ghost btn--desktop" href="/portal">Client Portal</a>
...
CTA = '''<section class="cta">
  <div class="container">
    ...
    <div class="cta__actions">
      <a class="btn btn--accent" href="/contact">Request a Financing Readiness Review
  ...
  <div class="container">
    <div class="site-footer__grid">
      ...
      <div>
        <h4>Services</h4>
        <ul>
          <li><a href="/services#cash-flow">Cash Flow Control</a></li>
          <li><a href="/services#reporting">Management Reporting</a></li>
          <li><a href="/services#working-capital">Working Capital</a></li>
          <li><a href="/services#financing">Financing Readiness</a></li>
        </ul>
      </div>
      <div>
        <h4>Contact</h4>
